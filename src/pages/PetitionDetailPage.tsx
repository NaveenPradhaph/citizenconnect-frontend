  ...
  if (!petition) {
    return (
      <div className="text-center py-12">
        <h3 className="text-2xl font-semibold text-gray-700 mb-2">Petition not found</h3>
        <p className="text-gray-500 mb-6">The petition you are looking for does not exist.</p>
        <Link to="/petitions" className="text-indigo-600 hover:text-indigo-800 font-medium">
          Back to Petitions
        </Link>
      </div>
    );
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center mb-6">
        <Link to="/petitions" className="text-gray-600 hover:text-gray-800 flex items-center">
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        <div className="flex items-center space-x-4 mb-6">
          <span className="text-sm px-3 py-1 rounded-full bg-blue-100 text-blue-700">Category: {petition.category}</span>
          <span className={`text-sm px-3 py-1 rounded-full ${getStatusColor(petition.status)}`}>
